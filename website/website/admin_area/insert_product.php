...
<head>
    ...
    <title>Insert Products-Amin Dashbord</title>
    <!-- bootstrap  css links -->
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/
    all.min.css" integrity="sha512-MV7K8+y+gLIBoVD59lQIYicR65iaqukzvf/nwasF0nqhPay5w/
...
<body class="bg-light">
    ...
    <!-- form-->
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            id="products_keywords" class="form-control" 
