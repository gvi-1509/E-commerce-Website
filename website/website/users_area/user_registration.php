...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-outline mb-4">
        ...
        required="reduired" name="user_username"/>
    </div>
    ...
    <div class="form-outline mb-4">
        ...
        required="reduired" name="user_email"/>
    </div>
    ...
    <div class="form-outline mb-4">
        ...
        required="reduired" name="user_image"/>
    </div>
     ...
     <div class="form-outline mb-4">
        ...
        required="reduired" name="user_password"/>
    </div>
    ...
    <div class="form-outline mb-4">
        ...
        required="reduired" name="conf_user_password"/>
    </div>
    ...
    <div class="form-outline mb-4">
        ...
        required="reduired" name="user_address"/>
    </div>
     ...
     <div class="form-outline mb-4">
        ...
        required="reduired" name="user_contact"/>
    </div>
