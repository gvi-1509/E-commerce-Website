...
// getting products
   ...
   function get_unique_brands(){
    ...
    $select_query="select * from products where brand_id=$brand_id"; 
      ...
      if($num_of_rows==0){
        echo "<h2 class='text-center text-danger'> This brand is not available
         for service</h2>";
      }
 ...
 // displaying brands in sidenav bar
   function getbrands(){
    global $con;
  ...
  // displaying categories in sidenav bar
...
// functio to get cart items numbers
   ...
   if(!isset($_GET['my_orders'])){
    if(!isset($_GET['delete_account'])){
      ...
      if($row_count>0){
        ...
        class='text-danger'>$row_count</span>
        pending orders</h3>
       <p class='text-center'> <a href='profile.php?my_orders' class='text-dark'>Order 
       Details</a></p>";
      }else{
      echo "<h3 class='text-center text-success mt-5 mb-2'> You have zero pending orders</h3>
       <p class='text-center'> <a href='../index.php' class='text-dark'>Explore
       products</a></p>";
      }
    }
  }
